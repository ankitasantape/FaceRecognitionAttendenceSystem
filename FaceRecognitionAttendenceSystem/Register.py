...
class Register:
    def __init__(self,root):
        ...
        #======== bg image ======================
        self.bg = ImageTk.PhotoImage(file=r"Resources/1080p_hd.jpg")
        lbl_bg = Label(self.root, image=self.bg)
        lbl_bg.place(x=0, y=0, relwidth=1, relheight=1)

        #=========== left image =======================
        self.bg1 = ImageTk.PhotoImage(file=r"Resources/registration.jpg")
        ...
        register_lbl = Label(frame, text="REGISTER HERE", font=("times new roman", 25, "bold"), fg="Blue", bg="white")
        ...
        #============= Buttons ============================
        img=Image.open("Resources/register-button-png-18469.png")
        ...
        img1 = Image.open("Resources/loginbtn.png")
